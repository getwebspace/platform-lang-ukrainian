...
return [
    ...
    'Setup SMTP or use SendPulse' => 'Налаштуйте SMTP або використовуйте SendPulse',
    ...
    'Middle copy size of uploaded image' => 'Розмір середньої копії завантаженого зображення',
    'Big copy size of uploaded image' => 'Розмір великої копії завантаженого зображення',
    ...
    'hours' => 'годин',
    'Enable Publications' => 'Увімкнути публікації',
    'Ability to publish posts by category' => 'Можливість публікації постів за категоріями',
    'Enable Pages' => 'Увімкнути сторінки',
    'Ability to add pages' => 'Можливість додавання сторінок',
    ...
    'Allow Methods' => 'Дозволити методи',
    'Allow Headers' => 'Дозволити заголовки',
    'Allow Origin' => 'Дозволити походження',
    'Turning SendPulse on and off' => 'Включення та вимкнення SendPulse',
    'The required parameters can be found in the account settings, in' => 'Необхідні параметри можна знайти в налаштуваннях облікового запису, в',
    'the API tab' => 'вкладці API',
    'Turning reCAPTCHA on and off' => 'Включення та вимкнення reCAPTCHA',
    'Robot protection' => 'Захист від роботів',
    'Public key of the reCAPTCHA service' => 'Публічний ключ сервісу reCAPTCHA',
    'This key will be used in the HTML code of the site for users devices' => 'Цей ключ буде використовуватися в HTML-коді сайту для пристроїв користувачів',
    'reCAPTCHA secret key' => 'Секретний ключ сервісу reCAPTCHA',
    'This key is needed for communication between the site and the reCAPTCHA service. Do not tell it to anyone' => 'Цей ключ потрібен для взаємодії між сайтом та сервісом reCAPTCHA. Нікому не повідомляйте його',
    ...
    'Price type for registered user' => 'Тип ціни для зареєстрованого користувача',
    'Allows change the type of sale price for a registered user' => 'Дозволяє змінити тип ціни продажу для зареєстрованого користувача',
    'Number of orders per day' => 'Кількість замовлень в день',
    'Allows set limit the maximum number of orders per delivery date. You can specify 0 if you do not want set limit' => 'Дозволяє встановити обмеження на максимальну кількість замовлень на дату доставки. Ви можете вказати 0, якщо не хочете встановлювати обмеження',
    ...
    'Payment order status' => 'Статус оплаченого замовлення',
    'Automatic change status after order payment via plugin' => 'Автоматично змінювати статус замовлення на вказаний після оплати через плагін',
    ...
    'Only latin letters are allowed: <code>[A-Za-z0-9]</code>' => 'Допустимі лише латинські літери: <code>[A-Za-z0-9]</code>',
];
